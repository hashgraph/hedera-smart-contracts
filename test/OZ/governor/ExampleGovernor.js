...
describe("ExampleGovernor", function () {
    ...
    before(async function () {
        ...
        const transferCalldata = exampleToken.interface.encodeFunctionData('transfer', [teamAddress, grantAmount]);
    ...
    it("should execute a proposal after it is successful", async function () {
        ...
        console.log(`Values: targets: ${actions.targets} value: ${actions.values} calldatas: ${actions.calldatas} descriptionHash: ${descriptionHash}`);
