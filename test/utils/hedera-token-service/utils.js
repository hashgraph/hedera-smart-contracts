...
const {
  getMirrorNodeUrl,
} = require('../evm-compatibility-ecrecover/utils');
...
class Utils {
   ...
   *                See https://github.com/hiero-ledger/hiero-contracts/blob/main/contracts/token-service/IHederaTokenService.sol#L156
   ...
   *            See https://github.com/hiero-ledger/hiero-contracts/blob/main/contracts/token-service/IHederaTokenService.sol#L132
   *                     for more information
   */
