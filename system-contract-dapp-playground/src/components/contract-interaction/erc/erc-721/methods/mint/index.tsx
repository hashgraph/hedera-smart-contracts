...
import { mintERC721ParamFields } from '@/utils/contract-interactions/erc/constant';
...
const Mint = ({ baseContract }: PageProps) => {
  ...
  const transactionResultStorageKey = 'HEDERA.EIP.ERC-721.TOKEN-MINT-RESULTS';
  ...
  return (
    <div className="w-full mx-3 flex justify-center mt-6">
      {/* approve() */}
      <MultiLineMethod
        paramFields={mintERC721ParamFields}
        methodName={'Mint'}
        params={mintParams}
