...
const { HederaMirrorNode } = require("./mirrornode");
...
class HederaSdkExecutor {
  constructor(name) {
    ...
    const getGrpcConfig = () => {
      ...
      const nodeAccount = AccountId.fromString(getEnvVar('NODE_ACCOUNT') || '0.0.3');
      let result = {};
      result[grpcUrl] = nodeAccount;
      return result;
    };
    const networkClient = {
      ...
      custom: () => Client.fromConfig(getGrpcConfig())
