...
interface IHederaTokenService {
    ...
    /// @custom:version 0.1.0 previous version did not include isApproval
    ...
    /// @custom:version 0.1.0 the signature of the previous version was cryptoTransfer(TokenTransferList[] memory tokenTransfers)
