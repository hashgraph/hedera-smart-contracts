...
contract AtomicHTS is HederaTokenService {
    /// events ///
    event BatchAlpha(int associateResponseCode, int grantKYCResponseCode, int transferTokenResponseCode);
    event BatchBeta(int transferTokenResponseCode, int approveResponseCode, int associateResponseCode, int grantKYCResponseCode, int transferFromResponseCode);
    event BatchCharlie(int unfreezeTokenResponseCode, int grantKYCResponseCode, int transferTokenResponseCode, int freezeTokenResponseCode);
    event BatchDelta(int wipeTokenResponseCode, int mintTokenResponseCode, int transferTokenResponseCode);
    event BatchEcho(int mintTokenResponseCode, int unfreezeTokenResponseCode, int grantKYCResponseCode, int freezeTokenResponseCode);
    event BatchFoxtrot(int associateResponseCode, int mintTokenResponseCode, int grantKYCResponseCode, int transferTokenResponseCode);
     ...
     */
    function batchAlpha(address token, address sender, address receiver, int64 amount) external {
        ...
        emit BatchAlpha(associateResponseCode, grantKYCResponseCode, transferTokenResponseCode);
    }
     ...
     */
    function batchBeta(address token, address owner, address receipient, int64 transferAmount, uint256 allowance) external {
        ...
        emit BatchBeta(transferTokenResponseCode, approveResponseCode, associateResponseCode, grantKYCResponseCode, transferFromResponseCode);
    }
    ...
    /**
      ...
      */
    function batchCharlie(address token, address sender, address receiver, int64 amount) external {
        ...
        emit BatchCharlie(unfreezeTokenResponseCode, grantKYCResponseCode, transferTokenResponseCode, freezeTokenResponseCode);
    }
     ...
     */
    function batchDelta(address token, address treasury, address owner, int64 wipedAmount, int64 mintAmount, int64 transferAmount) external {
        ...
        emit BatchDelta(wipeTokenResponseCode, mintTokenResponseCode, transferTokenResponseCode);
    } 
     ...
     */
    function batchEcho(address token, address sender, address receiver, int64 mintAmount, int64 transferAmount) external {
        bytes[] memory metadata;
        (int mintTokenResponseCode,,) = HederaTokenService.mintToken(token, mintAmount, metadata);
        require(mintTokenResponseCode == HederaResponseCodes.SUCCESS, "Failed to mint token.");
        ...
        emit BatchEcho(mintTokenResponseCode, unfreezeTokenResponseCode, grantKYCResponseCode, freezeTokenResponseCode);
    }
     ...
     */
    function batchFoxtrot(address token, address sender, address receiver, int64 amount) external {
        (int associateResponseCode) = HederaTokenService.associateToken(receiver, token);
        require(associateResponseCode == HederaResponseCodes.SUCCESS, "Failed to associate token.");
        ...
        emit BatchFoxtrot(associateResponseCode, mintTokenResponseCode, grantKYCResponseCode, transferTokenResponseCode);
    }
}
